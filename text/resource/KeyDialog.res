...
(Layout Content
    ...
    (Resources
        ...
        (Label12.TopOffset 1)
        (Label12.BottomOffset 8)
        (Label12.LeftOffset 3)
        (Label12.RightOffset 4)
        (OptionMenu3.TopOffset 1)
        (OptionMenu3.BottomOffset 8)
        (OptionMenu3.LeftOffset 3)
        (OptionMenu3.RightOffset 0)
        (OptionMenu3.Columns 10)
        (OptionMenu3.Names "0")
        (OptionMenu3.Labels "(not selected)")
        (Separator3.TopOffset 8)
        (Separator3.BottomOffset 7)
